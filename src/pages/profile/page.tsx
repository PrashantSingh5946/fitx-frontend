...
export default function Profile() {
  ...
  return (
    ...
    >
      <div className="flex gap-5 justify-center px-5 w-full text-base font-bold leading-6 text-white whitespace-nowrap max-w-[315px]">
      ...
      <div className="flex flex-row flex-wrap p-4 gap-4 justify-center">
        ...
        {/* Accounts Tab */}
        <div
          className="flex gap-5 justify-between px-5 py-6 mt-4 w-full rounded-2xl shadow-2xl bg-neutral-600/40 max-w-[315px]"
          style={{
            borderRadius: "10px",
          }}
        >
