              ...
              >
                <div className="u-container-layout u-similar-container u-container-layout-1">
                  ...
                  <p className="u-text u-text-2">
                    ...
                    dietary preferences, and goals to provide customized workout
                    plans and meal suggestions that align with your objectives.
                  </p>
                </div>
              </div>
              <div
              ...
              >
                <div className="u-container-layout u-similar-container u-container-layout-3">
                  ...
                  <p className="u-text u-text-6">
                    ...
                    tracking features. Keep tabs on your workouts, diet
                    adherence, and overall health metrics to stay motivated and
              ...
              >
                <div className="u-container-layout u-similar-container u-container-layout-4">
                  ...
                  <p className="u-text u-text-8">
                    ...
                    successes, seek advice, and celebrate milestones together in
            ...
            <div className="u-layout-row">
              ...
              <div className="u-align-left u-container-style u-layout-cell u-right-cell u-size-30 u-layout-cell-2">
                <div className="u-container-layout u-valign-middle u-container-layout-2">
                  ...
                  <p className="u-text u-text-2">
                    Discover personalized nutrition with FITX. Tailored to your
                    needs and goals, our customized diet plans optimize your
                    health journey. Say goodbye to generic diets and hello to a
                    personalized approach. Start today for a healthier tomorrow!
                  </p>
                  <img
                    src={dietImage}
                    alt=""
